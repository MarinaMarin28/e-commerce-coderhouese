...
export class Products{
    ...
    async AddProducts(product) {
        ...
        let productNew =  { 'id': newId, 'timestamp' : Date.now(), 'name': product.name, 'description': product.description, 'code': product.code, 'thumbnail': product.thumbnail, 'price': product.price, 'stock': product.stock};
